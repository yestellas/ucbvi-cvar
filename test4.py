...
if __name__ == '__main__':
    ...
    env_kwargs = dict(slip_prob=prob, I = i, K = k, T = t, alpha = a, seed=rand_seed)
    ...
    # agent1
    ucbvi_params1 = {"env": env1, "gamma": 1.0, "horizon": 10}
    ...
    np.save("./randomseed10_1", regret1)
    ...
    # agent2
    ucbvi_params2 = {"env": env2, "gamma": 1.0, "horizon": 10}
    ...
    ucbvi_params3 = {"env": env3, "gamma": 1.0, "horizon": 10}
    ...
    regret2 = np.cumsum(optimal2.value - ucb2)
    #baseline_regret2 = np.cumsum(optimal2.value - baseline2.value)
    regret3 = np.cumsum(optimal3.value - ucbvi3.value)
    #baseline_regret3 = np.cumsum(optimal3.value - baseline3.value)
    regret4 = np.cumsum(optimal4.value - ucbvi4.value)
    regret5 = np.cumsum(optimal5.value - ucbvi5.value)
    regret6 = np.cumsum(optimal6.value - ucbvi6.value)

    np.save("./randomseed10_2", regret2)
    np.save("./randomseed10_3", regret3)
    np.save("./randomseed10_4", regret4)
    np.save("./randomseed10_5", regret5)
    np.save("./randomseed10_6", regret6)
