...
class SimpleMDP(MDP):
    def __init__(self, n_states, n_actions, h, p, r, initial_state_distribution=None):
        self.p = np.asarray(p)
        self.r = np.asarray(r)
        self.h = h
        ...
        # self.initial_state_distribution = np.ones(self.n_states) / self.n_states
    ...
    def reset(self, initial_state=None):
        ...
        tg = np.random.choice(self.n_states, p=self.initial_state_distribution)
        return self.state, tg
